...
--
-- Name: stores_brands; Type: TABLE; Schema: public; Owner: Kyle; Tablespace: 
--
...
ALTER TABLE stores_brands OWNER TO "Kyle";
...
SELECT pg_catalog.setval('brands_id_seq', 351, true);
...
--
-- Data for Name: stores_brands; Type: TABLE DATA; Schema: public; Owner: Kyle
--
...
SELECT pg_catalog.setval('stores_brands_id_seq', 93, true);
...
SELECT pg_catalog.setval('stores_id_seq', 634, true);
